...
namespace Presentacion
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Persona persona1 = new Persona("Armando","Casas",9123456);
            Persona persona2 = new Persona("Alam","Brito", 9996582);
            Persona persona3 = new Persona("Juan","Perez", 78545282);
